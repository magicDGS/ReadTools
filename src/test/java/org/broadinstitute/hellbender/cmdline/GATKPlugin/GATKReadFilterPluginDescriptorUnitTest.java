 ...
 */
// TODO: this is included in https://github.com/broadinstitute/gatk/pull/2359
public class GATKReadFilterPluginDescriptorUnitTest {
    ...
    public void testWithDefaultReadFiltersWithParams() throws Exception {
        ...
        final CommandLineProgram clp = new TestWithDefaultReadFilters(
                Collections.singletonList(new ReadLengthReadFilter(10, 50)));
